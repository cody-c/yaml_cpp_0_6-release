...
int main() {
  {
    ...
    // move-like semantics
    YAML_0_6::Value root = YAML_0_6::Parse("test.yaml");
...

  {
    ...
    YAML_0_6::Value root = "Hello";  // Hello
    root = YAML_0_6::Sequence();     // []
    root[0] = 0;                 // [0]
    root[2] = "two";  // [0, ~, two]  # forces root[1] to be initialized to null

    YAML_0_6::Value other = root;  // both point to the same thing
  ...
  {
    YAML_0_6::Value seq = YAML_0_6::Sequence();
    seq[0] = "zero";  // [zero]
...

  {
    ...
    YAML_0_6::Value sub = root[1];  // &1 [bye, [hi, *1]]  # sub
