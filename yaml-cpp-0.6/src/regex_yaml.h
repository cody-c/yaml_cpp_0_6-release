...
class YAML_0_6_CPP_API RegEx {
 public:
  ...
  friend YAML_0_6_CPP_API RegEx operator!(const RegEx& ex);
  friend YAML_0_6_CPP_API RegEx operator||(const RegEx& ex1, const RegEx& ex2);
  friend YAML_0_6_CPP_API RegEx operator&&(const RegEx& ex1, const RegEx& ex2);
  friend YAML_0_6_CPP_API RegEx operator+(const RegEx& ex1, const RegEx& ex2);
