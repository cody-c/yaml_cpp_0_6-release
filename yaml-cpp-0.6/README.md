# yaml-cpp-0.6 [![Build Status](https://travis-ci.org/jbeder/yaml-cpp-0.6.svg?branch=master)](https://travis-ci.org/jbeder/yaml-cpp-0.6) [![Documentation](https://codedocs.xyz/jbeder/yaml-cpp.svg)](https://codedocs.xyz/jbeder/yaml-cpp/)
